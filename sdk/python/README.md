...
$env:AI_ESCROW_CHAIN_ID="84532"
$env:AI_ESCROW_AMOUNT_ETH="0.001"
$env:AI_ESCROW_DURATION_SECONDS="3600"
python .\ai_agent_escrow.py
```

The script creates an `order_id`, hashes the order payload into a unique `agreementHash`, and calls `createEscrow` with native Base Sepolia ETH value.
